...
export const metadata = {
  title: "Services — Strategic Marketing for Wellness & Nutraceuticals | The Wellness Ahead",
  description: "Explore our 11 strategic marketing capabilities for wellness, nutraceutical, dietary supplement, and herbal businesses — from brand positioning and scientific communication to B2B sales enablement and ongoing advisory.",
  keywords: [
  ...
  openGraph: {
    title: "Strategic Marketing Services for Wellness & Nutraceuticals | The Wellness Ahead",
    description: "From brand clarity and scientific communication to digital presence and ongoing consulting, discover how we help wellness brands get understood, trusted, and chosen.",
...
// All 11 Services Grouped with Serializable Data for Island SSR
const servicesData = [
  {
    id: "brand-strategy",
    number: "01",
    ...
    summary: "Establish a clear, defensible position that distinguishes your brand in a crowded market.",
    deliverables: [
      "Brand positioning",
      "Brand purpose",
      "Value proposition",
    ...
    outcome: "A clearer, more differentiated brand that audiences and business partners can understand and remember."
  },
  {
    ...
    category: "Foundation & Identity",
    summary: "Structure your product lines to capture category demand and maximize customer lifetime value.",
    deliverables: [
    ...
    outcome: "A more focused product portfolio aligned with market opportunities, consumer needs and brand direction."
  },
  {
    ...
    summary: "Translate complex clinical efficacy and bio-available formulations into trustworthy consumer language.",
    deliverables: [
    ...
    outcome: "Complex product information becomes clearer, more relevant and easier for customers and partners to understand."
  },
  {
    id: "packaging-labels",
    number: "04",
    ...
    category: "Product & Science",
    summary: "Optimize front-of-pack information hierarchy to win at retail shelves and e-commerce thumbnails.",
    deliverables: [
    ...
    outcome: "Packaging that communicates product value quickly, clearly and consistently."
  },
  {
    id: "digital-presence",
    number: "05",
    ...
    summary: "Build high-converting digital touchpoints that educate visitors and reflect clinical authority.",
    deliverables: [
      "Website strategy",
    ...
    outcome: "A more credible digital presence that educates visitors, reflects business strengths and generates better enquiries."
  },
  {
    ...
    category: "Digital & Channels",
    summary: "Develop category authority through informative, hype-free content that earns lasting organic loyalty.",
    deliverables: [
      "Content strategy",
      "Editorial planning",
    ...
    outcome: "A consistent communication system that builds visibility, understanding and trust over time."
  },
  {
    ...
    summary: "Position your founders and executives as trusted domain experts across industry forums and social networks.",
    deliverables: [
    ...
    outcome: "Greater leadership visibility, stronger industry credibility and a more human corporate presence."
  },
  {
    id: "launch-campaigns",
    number: "08",
    ...
    category: "Leadership & Growth",
    summary: "Execute synchronized multi-channel launch rollouts that generate immediate commercial traction.",
    deliverables: [
      "Launch strategy",
    ...
    outcome: "A structured product launch with consistent messaging and coordinated communication across channels."
  },
  {
    id: "b2b-enablement",
    number: "09",
    ...
    summary: "Empower sales teams, distributors, and contract manufacturing pipelines with institutional collateral.",
    deliverables: [
      "B2B positioning",
    ...
    outcome: "Stronger business credibility and clearer communication with brands, distributors, importers and strategic partners."
  },
  {
    id: "market-research",
    number: "10",
    ...
    category: "Commercial & B2B",
    summary: "De-risk major product and positioning decisions with comprehensive qualitative and quantitative insights.",
    deliverables: [
      "Competitor research",
      "Category research",
      "Consumer-trend research",
    ...
    outcome: "Better strategic decisions supported by structured research and market understanding."
  },
  {
    ...
    category: "Commercial & B2B",
    summary: "Access continuous strategic counsel, campaign reviews, and team guidance as your wellness business scales.",
    deliverables: [
    ...
    outcome: "Consistent direction, stronger coordination and better use of marketing resources."
  }
];
  ...
  "@graph": [
    {
      ...
      "description": "Comprehensive strategic marketing capabilities for wellness, dietary supplement, and herbal businesses.",
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          {
  ...
  return (
    <SmoothScroll>
      <main className="relative min-h-screen bg-[#ece8df] text-[#1c2e22] font-sans antialiased selection:bg-[#97ad8d] selection:text-[#0b2b18]">
        ...
        <section
          id="services-hero"
          className="group relative min-h-[60vh] md:min-h-[68vh] flex items-center justify-center overflow-hidden pt-44 sm:pt-52 md:pt-56 pb-16 sm:pb-20 bg-gradient-to-b from-[#ece8df] via-[#f4efe4] to-[#ece8df] text-center border-b border-[#ded6c7] transition-all duration-700 select-none"
        >
          ...
          <div className="relative z-20 max-w-[1440px] w-full mx-auto px-4 sm:px-8 lg:px-12 flex flex-col items-center justify-center">
            <div className="max-w-3xl sm:max-w-4xl mx-auto flex flex-col items-center mt-4 sm:mt-6 md:mt-8">
              ...
              <h1 className="font-raleway text-3xl sm:text-4xl md:text-5xl lg:text-[54px] xl:text-[58px] text-[#0d3822] tracking-[0.02em] font-semibold leading-[1.18] text-center transition-transform duration-700 ease-out group-hover:scale-[1.01]">
                <span>Strategic Marketing Services for </span>
                <span className="block mt-1 sm:mt-2 text-[#075f2c] font-bold transition-all duration-500 group-hover:text-[#0b6c34] group-hover:drop-shadow-[0_2px_20px_rgba(7,95,44,0.18)]">
                  Wellness &amp; Nutraceutical Businesses.
                </span>
              </h1>
              ...
              <p className="mt-6 sm:mt-7 text-base sm:text-lg md:text-xl text-[#344d39] font-normal leading-[1.75] tracking-[0.02em] max-w-3xl mx-auto text-center transition-colors duration-500 group-hover:text-[#1e3b26]">
                From brand clarity and product communication to digital presence and ongoing consulting, our services help wellness businesses strengthen how they are understood, trusted and positioned in the market.
              </p>
              ...
              <div className="mt-9 sm:mt-10 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
                <a
                  href="#services-list"
                  className="inline-flex items-center justify-center gap-2 px-7 py-3 rounded-xl text-sm sm:text-base font-medium text-white bg-[#0e3520] hover:bg-[#072415] transition-all duration-300 shadow-md hover:shadow-[0_10px_25px_rgba(14,53,32,0.28)] transform hover:-translate-y-0.5"
                >
                  <span>View All 11 Capabilities</span>
                  <span>↓</span>
                </a>
                <Link
                  href="/#contact"
        ...
        {/* 3. Main Services Catalog: Sticky Pinned Showcase + Compact Scrolling Cards */}
        <section id="services-list" className="py-20 sm:py-28 bg-[#ece8df]">
          <div className="max-w-[1440px] w-full mx-auto px-4 sm:px-8 lg:px-12">
            ...
            <div className="max-w-3xl mb-12 sm:mb-16">
              ...
              <h2 className="font-raleway text-3xl sm:text-4xl md:text-[42px] text-[#0d3822] font-semibold tracking-tight leading-tight mb-4">
                Structured Advisory &amp; Execution Support
              </h2>
              <p className="text-base sm:text-lg text-[#405644] font-normal leading-relaxed">
            ...
            <div className="relative bg-[#0d3822] text-white rounded-3xl sm:rounded-[2.25rem] px-6 py-12 sm:px-12 sm:py-16 text-center border border-[#235839] shadow-[0_20px_50px_rgba(13,56,34,0.22)] overflow-hidden">
              ...
              <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <p className="mt-6 text-sm sm:text-base text-[#d2e0ce] font-normal leading-relaxed max-w-xl mx-auto">
                  A 30-minute discovery conversation can help assess your category positioning, communication bottlenecks, and the highest-leverage marketing priorities.
                </p>
