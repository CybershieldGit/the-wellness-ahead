...
const insightsList = [
  {
    ...
    description:
      "Scientific innovation is the backbone of the nutraceutical industry, but translating that into consumer language requires a different kind of clarity.",
    takeaway:
      "Bridging the divide between formulation rigor and consumer comprehension.",
  ...
  },
  {
    ...
    description:
      "Building trust through useful information rather than persuasion-driven messaging. Packaging that informs creates durable customer loyalty.",
  ...
  },
  {
    ...
    readTime: "6 min read",
    title:
      "How B2B Nutraceutical Businesses Can Build a Stronger Digital Presence",
    description:
      "Why manufacturers and ingredient companies need more than a product catalogue online to build institutional credibility and attract enterprise buyers.",
    takeaway:
      "Positioning contract manufacturing with modern enterprise authority.",
  ...
  },
  {
    ...
    description:
      "The cost of promoting a brand that has not yet defined what it stands for. Why clear market positioning accelerates every marketing dollar spent.",
            ...
            <div className="relative bg-[#0d3822] text-white rounded-3xl sm:rounded-[2.25rem] px-6 py-12 sm:px-12 sm:py-16 text-center border border-[#235839] shadow-[0_20px_50px_rgba(13,56,34,0.22)] overflow-hidden">
              ...
              <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <p className="mt-6 text-sm sm:text-base text-[#d2e0ce] font-normal leading-relaxed max-w-xl mx-auto">
                  Let’s discuss your current market positioning, formulation
                  storytelling, and how to communicate product strengths more
                  effectively.
                </p>
