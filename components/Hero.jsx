...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-[92vh] md:min-h-screen flex items-center justify-start overflow-hidden pt-36 sm:pt-40 md:pt-44 pb-16 md:pb-20">
      ...
      {/* Main Hero Content */}
      <div className="relative z-30 max-w-[1440px] w-full mx-auto px-4 sm:px-8 lg:px-12 pt-4 md:pt-8 mt-2 sm:mt-4 md:mt-6">
        <div className="max-w-5xl lg:max-w-[980px]">
          {/* Main Headline (Clean Duotone Luxury Contrast Pattern) */}
          <h1 className="font-raleway text-3xl sm:text-4xl md:text-5xl lg:text-[54px] xl:text-[58px] text-white tracking-[0.02em] drop-shadow-sm flex flex-col gap-1.5 sm:gap-2.5 font-normal leading-[1.14]">
          ...
          {/* Subtitle with refined tight margin & luxury line height */}
          <p className="mt-5 sm:mt-6 text-base sm:text-lg md:text-xl text-gray-200 font-normal leading-[1.65] tracking-[0.02em] max-w-2xl drop-shadow-sm">
